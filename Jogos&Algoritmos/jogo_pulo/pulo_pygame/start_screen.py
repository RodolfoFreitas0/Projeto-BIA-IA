...
class StartScreen:
    def __init__(self, screen, clock, title):
        ...
        self.play_rect = pygame.Rect(self.width//2 - 150, 160, 300, 80)
        self.quit_rect = pygame.Rect(self.width//2 - 150, 280, 300, 80)
    ...
    def draw(self):
        ...
        self.screen.blit(
            title_surf,
            title_surf.get_rect(center=(self.width//2, 80))
        )
